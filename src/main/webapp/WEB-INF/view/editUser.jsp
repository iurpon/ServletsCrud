...
<body>
    ...
    <c:if test = "${actions eq 'update'}">
        ...
        <form method="post" action="updateUser" class="ui-form">
            ...
            <div class="form-row">
                <input type="text" id="name"  value="${user.userName}" name="name" required autocomplete="off"><label for="name">Name</label>

            </div>
            <div class="form-row">
                <input type="" id="role" value="${user.role}" name="role" list="roles" required autocomplete="off"><label for="role">Role</label>
               <datalist id="roles">
                  <option value="ADMIN">
                  <option value="USER">
                </datalist>
    ...
    <form method="post" action="addUser" class="ui-form">
        ...
        <div class="form-row">
            <input type="password"  id="password" name="password" required autocomplete="off"><label for="name">Password</label>
        </div>
        <div class="form-row">
            <input type="text"  id="role" name="role" list="roles" required autocomplete="off"><label for="role">Role</label>
            <datalist id="roles">
              <option value="ADMIN">
              <option value="USER">
            </datalist>
